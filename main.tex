...
Dans ce section, on fait un étude sur la nombre d'inertie, which is a verrou que on a mentionné dans le objet de thèse.
Augmentation du nombre d'inertie du test triaxial , cest a dire Montée la vitesse imposée. Normalement, $$
\begin{table}[h!]
\centering
\begin{tabular}{|c|c|c|}
\hline
$ I < 10^{-4} $ & $ 10^{-4} < I < 10^{-1} $ & $ I > 10^{-1} $ \\ 
\hline
Solides & Fluides & Gaz \\  
\hline
\end{tabular}
